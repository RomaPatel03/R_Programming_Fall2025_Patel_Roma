...
+ cat("Student (S3):", x$name, "- Age:", x$age, "- GPA:", x$GPA, "\n")}
> print(s3_obj)
Student (S3): Myself - Age: 29 - GPA: 3.5 
> setClass("student_s4",
...
+ cat("Student (S4):", object@name, "- Age:", object@age, "- GPA:", object@GPA, "\n") })
> s4_obj
Student (S4): Myself - Age: 29 - GPA: 3.5 
